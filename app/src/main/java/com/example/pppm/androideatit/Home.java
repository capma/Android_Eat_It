...
import com.example.pppm.androideatit.Model.Category;
import com.example.pppm.androideatit.ViewHolder.MenuViewHolder;
...
//        FirebaseRecyclerOptions options = new FirebaseRecyclerOptions.Builder<Category>().setQuery(categoryQuery, Category.class).build();
